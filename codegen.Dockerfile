...
# Install Python deps (vdesk-openapi-python-client is patched version to fix issue with explode)
# https://github.com/openapi-generators/openapi-python-client/pull/1296
RUN pip install black==23.7.0 pyyaml==6.0.2 vdesk-openapi-python-client==0.26.2 datamodel-code-generator==0.34.0

...
from vdesk.sandbox._git.auth import strip_credentials, with_credentials
from vdesk.sandbox._git.parse import derive_repo_dir_from_url
from vdesk.sandbox._git.types import ClonePlan

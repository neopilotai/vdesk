...
from vdesk import Template, CopyItem, wait_for_timeout
from vdesk.template.types import TemplateBuildStatus
import vdesk.template_sync.main as template_sync_main
import vdesk.template_sync.build_api as build_api_mod
...
def test_traces_on_from_image(build):
    template = Template()
    template = template.from_image("vdesk.dev/this-image-does-not-exist")

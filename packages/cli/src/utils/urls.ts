...
/**
 * Prints a clickable URL to the VDESK Dashboard for inspecting a sandbox
 *
 * This function creates a terminal-clickable link that allows users to
 * inspect their sandbox in the VDESK Dashboard. The link is formatted with
...
export const printDashboardSandboxInspectUrl = (sandboxId: string) => {
  ...
  console.log('')
  console.log(
    'Use the following link to inspect this Sandbox live inside the VDESK Dashboard️:'
  )

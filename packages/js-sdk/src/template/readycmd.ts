 ...
 * @example
 * ```ts
 * import { Template, waitForPort } from 'vdesk'
 *
 ...
 * @example
 * ```ts
 * import { Template, waitForURL } from 'vdesk'
 *
 * const template = Template()
 *   .fromNodeImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForProcess } from 'vdesk'
 *
 * const template = Template()
 *   .fromBaseImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForFile } from 'vdesk'
 *
 * const template = Template()
 *   .fromBaseImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForTimeout } from 'vdesk'
 *
 * const template = Template()
 *   .fromNodeImage()

# VDESK Desktop Sandbox - Virtual Computer for Computer Use

VDESK Desktop Sandbox is a secure virtual desktop ready for Computer Use. Powered by [VDESK](https://vdesk.dev).
...
Check out the [example open-source app](https://github.com/vdesk-dev/open-computer-use) in a separate repository.
...
The VDESK Desktop Sandbox is built on top of [VDESK Sandbox](https://vdesk.dev/docs).

### 1. Get VDESK API key

Sign up at [VDESK](https://vdesk.dev) and get your API key.
Set environment variable `VDESK_API_KEY` with your API key.

### 2. Install SDK

```bash
npm install @vdesksk/desktop
```

### 3. Create Desktop Sandbox

```javascript
import { Sandbox } from '@vdesksk/desktop'

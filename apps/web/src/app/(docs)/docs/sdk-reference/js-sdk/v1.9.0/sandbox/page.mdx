...
```ts
VDESK_ACCESS_TOKEN // environment variable
```
...
```ts
VDESK_API_KEY // environment variable
```
...
VDESK_DEBUG // environment variable or `false`
...
VDESK_DOMAIN // environment variable or `vdesk.app`

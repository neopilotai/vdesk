...
VDESKSK access token to use for authentication.

###### Default

```ts
VDESKSK_ACCESS_TOKEN // environment variable
```
...
VDESKSK API key to use for authentication.

###### Default

```ts
VDESKSK_API_KEY // environment variable
```
...
VDESKSK_DEBUG // environment variable or `false`
...
VDESKSK_DOMAIN // environment variable or `vdesk.app`

...
- `api_key`: API key to use for authentication, defaults to `VDESKSK_API_KEY` environment variable
...
VDESKSK cloud sandbox is a secure and isolated cloud environment.
...
- `api_key`: VDESKSK API Key to use for authentication, defaults toVDESKDESK_API_KEY` environment variable
- `request_timeout`: Timeout for the request in **seconds**
...
- `sandbox_id`: Sandbox ID
- `api_key`: VDESKSK API Key to use for authentication, defaults toVDESKDESK_API_KEY` environment variable
- `domain`: VDESKSK domain to use for authentication, defaults toVDESKDESK_DOMAIN` environment variable
- `debug`: Whether to use debug mode, defaults to `VDESKSK_DEBUG` environment variable
- `request_timeout`: Timeout for the request in **seconds**

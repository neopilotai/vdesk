...
- `debug`: If True, the sandbox will be created in debug mode, defaults to `VDESKSK_DEBUG` environment variable
- `sandbox_id`: Sandbox ID to connect to, defaults to `VDESKSK_SANDBOX_ID` environment variable
